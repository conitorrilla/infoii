...
var style_poblacion_1 = function(feature, resolution){
    ...
    var value = feature.get("PoblacionT");
    var labelText = "";
    size = 0;
    ...
    if (value >= 53.000000 && value <= 20049.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20049.000000 && value <= 53622.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 53622.000000 && value <= 107733.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 107733.000000 && value <= 222797.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 222797.000000 && value <= 372616.000000) {
            style = [ new ol.style.Style({
